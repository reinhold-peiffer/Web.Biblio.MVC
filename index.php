...
// Définition constante URL, basée sur la superglobale $_SERVER 
// avec une condition ternaire pour identifier le protocole
// pour accéder aux ressources, à partir de la racine du site : chemin absolu 
...
try {
    if (empty($_GET['page'])) {
        ...
        // Fonction static définie dans classe Securite 
        // pour securiser saisie utilisateur (faille XSS)
        $page = Securite::secureHTML($_GET['page']);

        // On décompose l'URL (fonction explode) 
        // avec filtre caractères spéciaux (sécurité),
        // pour permettre différentes routes dans les cases 
        // et véhiculer vers le bon canal : CRUD
        ...
        switch ($url[0]) {
            ...
            case "error403":
                ...
                throw new  Exception("Erreur 403 : accès refusé!");
                break;
