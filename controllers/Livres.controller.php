<?php
require_once "models/Livre.dao.class.php";
require_once "models/Auteur.dao.class.php";
require_once "utilities/Image.class.php";
...
class LivresController
{
    ...
    public function ajoutLivreValidation()
    {
        ...
        $nomImageAjoute =  Image::ajoutImage($file, $repertoire);
    ...
    public function modificationLivreValidation()
    {
        ...
        if ($file['size'] > 0) {
            ...
            // Upload image dans le dossier spécifié, par l'intermédiaire d'une
            // fonction static définie dans classe Image
            $nomImageToAdd = Image::ajoutImage($file, $repertoire);
        } else {
