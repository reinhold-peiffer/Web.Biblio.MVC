...
<body>
    ...
    <div class="container">
        ...
        <!-- Menu -->
        <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark mt-2 perso_shadow" id="header">
        ...
        <!-- Contenu des pages -->
        <div class="container perso_shadow" id="content">
            <h1 class="text-center mt-2"><?= $titre ?></h1>
            <?= $content ?>
        </div>
